...
<div class="glass-card text-center" style="max-width:500px">
    <i class="bi bi-emoji-frown display-1" style="background:linear-gradient(135deg,#d4869c,#e8a0b4);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text"></i>
    <h1 class="mt-3" style="font-size:4rem;font-weight:800;background:linear-gradient(135deg,#d4869c,#e8a0b4);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text">404</h1>
