...
<div class="admin-wrapper">
    ...
    <main class="admin-content">
        <div class="content-header">
            ...
            <a href="${pageContext.request.contextPath}/admin/friend?action=add" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> 添加友链</a>
        </div>
            ...
            <table class="table table-dark table-hover mb-0">
                ...
                <c:forEach items="${friends}" var="f">
                    <tr>
                        ...
                        <td>
                            <a href="${pageContext.request.contextPath}/admin/friend?action=edit&id=${f.id}" class="btn btn-sm btn-outline-light"><i class="bi bi-pencil"></i></a>
                            <form action="${pageContext.request.contextPath}/admin/friend" method="post" style="display:inline" onsubmit="return confirm('确定删除此友链？')">
