...
<div class="admin-wrapper">
    ...
    <main class="admin-content">
        <div class="content-header">
            ...
            <a href="${pageContext.request.contextPath}/admin/friendLink" class="btn btn-outline-light btn-sm"><i class="bi bi-arrow-left"></i> 返回</a>
        </div>
        <div class="glass-card">
            <form action="${pageContext.request.contextPath}/admin/friendLink" method="post">
                ...
                <a href="${pageContext.request.contextPath}/admin/friendLink" class="btn btn-outline-light">取消</a>
            </form>
        </div>
    </main>
</div>
